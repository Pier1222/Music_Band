...
$array_genres = getArrayDeezer("https://api.deezer.com/genre", $certificate, false)["data"];
//print_r($array_genres[0]);


//Je sais que Deezer limite déjà le nombre de morceaux à 10 dans ses tops mais on ne sait jamais
$array_top_10_singles = getArrayDeezer("https://api.deezer.com/chart/0/tracks?limit=10", $certificate, false)["data"];
...
$array_top_10_albums = getArrayDeezer("https://api.deezer.com/chart/0/albums?limit=10", $certificate, false)["data"];
...
for ($i=0; $i < count($array_top_10_albums); $i++) {
    ...
    $array_tracks_album_actu = getArrayDeezer($request_actu, $certificate, false)["data"];
...
//L'artiste du moment
$artist_moment = getArrayDeezer("https://api.deezer.com/chart/0/artists?limit=1", $certificate, false)["data"][0];

//Test avec d'autres artistes
/*$artist_moment = getArrayDeezer("https://api.deezer.com/chart/0/artists?index=7?limit=1", $certificate, false)["data"][0];*/

//Top des playlists
$array_top_playlists = getArrayDeezer("https://api.deezer.com/chart/0/playlists?limit=30", $certificate, false)["data"];

//Les moments radios préférés
$array_top_radio_replay = getArrayDeezer("https://api.deezer.com/chart/0/podcasts?limit=4", $certificate, false)["data"];

function getArrayDeezer($request, $certificate, $debug_echo) {
    $curl = curl_init();
        ...
        <body>
            ...
            <div class="div_caroussel">
                ...
                <div class="div_caroussel_elements_list">
                    <?php for ($i=0; $i < count($array_genres); $i++) { ?>
