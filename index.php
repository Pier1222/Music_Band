...
<html>
    ...
    <div class="container">
        ...
        <body onload="initialisation()" onmousedown="checkMouseX(event)" onmouseup="unCheckMouseX(event)">
            ...
            <div class="div_caroussel">
                ...
                <button class="slide-arrow" id="slide-arrow-prev" onclick="slideChange(true)">
                    &#8249;
                </button>
  
                <button class="slide-arrow" id="slide-arrow-next" onclick="slideChange(false)">
                    &#8250;
                </button>


                <div class="div_caroussel_elements_list" id="caroussel_genre" onmousemove="moveCarousselX(event)">
